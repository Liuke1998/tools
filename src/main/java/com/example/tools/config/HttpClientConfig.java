...
import com.example.tools.config.properties.HttpClientProperties;
...
public class HttpClientConfig {
    ...
    public PoolingHttpClientConnectionManager getHttpClientConnectionManager(HttpClientProperties httpClientProperties){
     ...
     */
    @Bean(name = "builder")
    public RequestConfig.Builder getBuilder(HttpClientProperties httpClientProperties){
